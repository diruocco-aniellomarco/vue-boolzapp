...
createApp({
  ...
  methods: {
    ...
    searchChat() {
      const nomeRicercato = this.ricercaNome.toLowerCase();
      for (let i = 0; i < this.contacts.length; i++) {
        const nomeChat = this.contacts[i].name.toLowerCase();
        this.contacts[i].visible = nomeChat.includes(nomeRicercato);
      }
    },
